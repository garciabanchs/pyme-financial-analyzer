...
from parser_financiero import extraer_importes, extraer_fecha, extraer_resumen_extracto
...
def home():
    ...
    <head>
      ...
      <style>
        ...
        .hero { background:linear-gradient(135deg,#0f172a,#1d4ed8); color:white; padding:70px 20px; text-align:center; }
        .hero h1 { margin:0 0 20px 0; font-size:42px; line-height:1.2; }
        .hero p { max-width:800px; margin:0 auto 30px auto; font-size:20px; line-height:1.6; }
        .cta-btn {
          display:inline-block; background:#f59e0b; color:#111827; padding:16px 28px; border-radius:10px;
          text-decoration:none; font-weight:bold; font-size:18px; border:none; cursor:pointer;
        }
        .section { max-width:1100px; margin:0 auto; padding:60px 20px; }
        .section h2 { text-align:center; font-size:32px; margin-bottom:20px; }
        .section p.lead { text-align:center; font-size:18px; max-width:850px; margin:0 auto 40px auto; line-height:1.7; }
        .cards { display:grid; grid-template-columns:repeat(auto-fit,minmax(250px,1fr)); gap:20px; }
        .card { background:white; padding:25px; border-radius:14px; box-shadow:0 8px 24px rgba(0,0,0,0.08); }
        .card h3 { margin-top:0; font-size:22px; }
        .card p { line-height:1.6; font-size:16px; }
        .outputs { background:#eaf1ff; border-radius:16px; padding:30px; }
        .footer-cta { text-align:center; padding:60px 20px 80px 20px; }
        .footer-cta h2 { font-size:34px; margin-bottom:20px; }
        .footer-cta p { font-size:18px; max-width:800px; margin:0 auto 30px auto; line-height:1.6; }
        .upload-form { margin-top:25px; }
        .file-input { margin-bottom:15px; font-size:16px; }
      </style>
    </head>
    <body>
      <section class="hero">
      ...
      <section class="section">
        ...
        <div class="cards">
          ...
          <div class="card">
            ...
            <p>El sistema lee PDFs, extrae texto, clasifica documentos y construye un ledger completo movimiento por movimiento.</p>
          </div>
          <div class="card">
